...
def _intake_step(cs, user_text, locale) -> dict | None:
    ...
    if current and user_text:
        ...
        # any rich message, on every intake turn — merging ONLY into empty slots so an
        # earlier confirmed answer is never clobbered. slots.model stays raw customer text.
